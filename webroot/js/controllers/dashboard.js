	...
	app.controller('infoController', ['$scope','restHandler', '$interval', '$http', function($scope, restHandler, $interval, $http) {
		...
		$scope.init = function(){
			...
			$interval($scope.updateInfo, 5000);
